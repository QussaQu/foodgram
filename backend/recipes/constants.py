...
COLOR_HELPER = 'Цветовой HEX-код тега'
SLUG_HELPER = 'Уникальный идентификатор тега'
REC_NAME_HELPER = 'Название рецепта'
AUTHOR_HELPER = 'Автор рецепта'
IMAGE_HELPER = 'Изображение рецепта'
TEXT_HELPER = 'Описание рецепта'
PUB_DATE_HELPER = 'Дата публикации'
COOKING_TIME_HELPER = 'Время приготовления рецепта'
TAGS_OF_REC_HELPER = 'Теги рецепта'
